...
# page 340
def 꺾은선():
    font_name = font_manager.FontProperties(fname="GULIM.TTC").get_name()
...
# 348 (1)
data = [0.18,0.3,3.3, 3.75, 0.38, 25, 0.25, 2.75, 0.1]      # 리스트 값
label = ['비타민A','비타민B1','비타민B2', '나이아신', '비타민 B6','비타민 C', '비타민 D', '비타민E', '엽산']      # 리스트 값
원형그래프(data, label)
